...
import com.gallapillo.stocks.presentation.theme.BetterWhite
import com.gallapillo.stocks.presentation.theme.Violet
    ...
    Canvas(modifier = modifier) {
        ...
        val strokePath = Path().apply {
            ...
            for (i in infos.indices) {
                ...
                val rightRatio = (nexInfo.close - lowerValue) / (upperValue - lowerValue)
